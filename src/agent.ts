...
const BaseTemplateItemSchema = z.object({ titulo_no_template: z.string(), origem: z.string(), texto_base: z.string(), ausente_no_template: z.boolean() });
